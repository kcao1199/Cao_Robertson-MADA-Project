...
## Finding NAs and Missing Values
...
library(naniar)
```
First, I load the data into a usabel dataframe.
```{r}
...
naniar::gg_miss_var(NISTeenVax2)
```
...
saveRDS(NISTeenVax4, file = "./data/processed-data/clean_data1.rds")
```
