...
Next, the distribution of surveys given per state was analyzed.
...
![Figure 2. State distribution](./images/state.distribution.png)
...
![Figure 3. The family income distribution](./images/family.income.distribution.png)
...
![Figure 4.Racial distribution](./images/race.distribution.png)

![Figure 5.Ethnicity distribution](./images/ethnicity.distribution.png)
...
![Figure 6. Insurance status distribution](./images/insurance.status.distribution.png) ![Figure 7. Distribution of the medical facility where the survey was administerred](./images/facility.distribution.png)
...
![Table 2. Vaccine status distribution](./images/state-vaccine-completion.png)
...
![Figure 8.Facility and vaccine completion distribution](./images/facility-vaccination.png)
...
![Figure 9. Distribution of vaccine completion stratified by race and ethnicity](./images/raceeth-income-stratified.png)
...
![Figure 10.](./images/income-vaccination.png)
...
![Figure 12. Income-poverty level versus ethnic group](./images/raceeth-income-stratified.png)
