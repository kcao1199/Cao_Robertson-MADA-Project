...
rf_workflow_mull <- workflow() %>% # create workflow with the recipe and spec
...
# Get predictions for tuned model
rf_tuned <- augment(rf_res, train_data)

# Get predictions for first fit model

# Create combined data frame

# Plot tuned model, first fit, and single predictor model together


```
```{r}
# RF model performance with cross validation
